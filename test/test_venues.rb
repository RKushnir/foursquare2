...
class TestVenues < Test::Unit::TestCase
  ...
  context "When using the foursquare API and working with venues" do
    ...
    should "fetch info for a single venue" do
      stub_get("/venues/4b8c3d87f964a520f7c532e3?oauth_token=#{@client.oauth_token}", "venues/venue.json")
    ...
    should "search for venues based on passed criteria" do
      stub_get("/venues/search?ll=36.142064%2C-86.816086&oauth_token=#{@client.oauth_token}&query=coffee", "venues/search_venues.json")
    ...
    should "search for trending venues around a certain position" do
      stub_get("/venues/trending?ll=36.132832%2C-115.151827&radius=10000&oauth_token=#{@client.oauth_token}", "venues/trending_venues.json")
    ...
    should "search for venues from a tip search" do
      stub_get("/tips/search?ll=-23.013968%2C-45.550802&oauth_token=#{@client.oauth_token}&query=rodoviaria", "venues/search_venues_by_tip.json")
    ...
    should "not find venues from a tip search" do
      stub_get("/tips/search?ll=-23.013968%2C-45.550802&oauth_token=#{@client.oauth_token}&query=loremlpsun", "venues/no_venues_by_tip.json")
    ...
    should "get tips from a venue" do
      stub_get("/venues/4b8c3d87f964a520f7c532e3/tips?oauth_token=#{@client.oauth_token}", "venues/venue_tips.json")
    ...
    should "get tips from a venue only with some term" do
      stub_get("/venues/4c94a45c82b56dcb47cad0aa/tips?oauth_token=#{@client.oauth_token}", "venues/venue_tips.json")
    ...
    should "allow venues to be explored" do
      stub_get("/venues/explore?section=food&ll=40.7%2C-74&oauth_token=#{@client.oauth_token}&limit=2", "venues/explore_venues.json")
    ...
    should "get photos for a venue" do
      stub_get("/venues/4b8c3d87f964a520f7c532e3/photos?group=venue&oauth_token=#{@client.oauth_token}&limit=3", "venues/venue_photos.json")
    ...
    should "should suggest venues based on passed criteria" do
      stub_get("/venues/suggestCompletion?oauth_token=#{@client.oauth_token}&ll=40.7%2C-74&query=coffee", "venues/suggest_completion_venues.json")
    ...
    should "fetch venue for manager" do
      stub_get("/venues/managed?oauth_token=#{@client.oauth_token}", "venues/managed_venues.json")
    ...
    should "get menus for a venue" do
      stub_get("/venues/4b2a544ff964a5204ca724e3/menu?oauth_token=#{@client.oauth_token}", "venues/venue_menus.json")
    ...
    should "get currently checked in users for a venue" do
      stub_get("/venues/4a1c8506f964a520457b1fe3/herenow?oauth_token=#{@client.oauth_token}", "venues/venue_herenow.json")
    ...
    should "get detailed stats for a venue managed by user" do
      stub_get("/venues/4b8c3d87f964a520f7c532e3/stats?oauth_token=#{@client.oauth_token}", "venues/venue_stats.json")
    ...
    should "get a subset of detailed stats for a venue managed by user when passing in options" do
      stub_get("/venues/4b8c3d87f964a520f7c532e3/stats?oauth_token=#{@client.oauth_token}&startAt=1343085269&endAt=1343171627", "venues/venue_stats.json")
    ...
    should "get hours from a venue" do
      stub_get("/venues/49d68c61f964a520e65c1fe3/hours?oauth_token=#{@client.oauth_token}", "venues/venue_hours.json")
    ...
    context "and getting detailed stats for a venue not managed by user" do
      should "raise a 'not authorized' API error" do
        stub_get("/venues/4ad4c04af964a52065f220e3/stats?oauth_token=#{@client.oauth_token}", nil,
