...
class TestCheckins < Test::Unit::TestCase
  ...
  context "When using the foursquare API and working with checkins" do
    ...
    should "fetch info for a single checkin" do
      stub_get("/checkins/4d572bcc9e508cfab975189b?oauth_token=#{@client.oauth_token}", "checkins/checkin.json")
    ...
    should "fetch recent checkins from friends"do
      stub_get("/checkins/recent?oauth_token=#{@client.oauth_token}&limit=2", "checkins/friend_checkins.json")
    ...
    should "add a post to an existing checkin" do
      stub_post("/checkins/5041335de4b08d95c1591453/addpost?oauth_token=#{@client.oauth_token}&text=Test", "checkins/post_created.json")
    ...
    should "add a reply to an existing checkin" do
      stub_post("/checkins/5041eda9e4b0133020c2292c/reply?oauth_token=#{@client.oauth_token}&text=Test", "checkins/checkin_reply.json")
