...
class TestCampaigns < Test::Unit::TestCase
  ...
  context "When using the foursquare API and working with campaigns" do
    ...
    should "get a campaign" do
      stub_get("/campaigns/4e0deba2922e6f94b1410b79?oauth_token=#{@client.oauth_token}", "campaigns/campaign.json")
      campaign = @client.campaign('4e0deba2922e6f94b1410b79')
      campaign.id.should == "4e0deba2922e6f94b1410b79"
    end

    should "add a campaign" do
      stub_post("/campaigns/add?oauth_token=#{@client.oauth_token}&specialId=4bd876f886ba62b58a6e88b3", "campaigns/campaign_created.json")
      campaign = @client.add_campaign(:specialId => '4bd876f886ba62b58a6e88b3')
      campaign.special.id.should == "4bd876f886ba62b58a6e88b3"
    end

    should "list all campaigns" do
      stub_get("/campaigns/list?oauth_token=#{@client.oauth_token}&status=active", "campaigns/campaigns_list.json")
    ...
    should "list campaigns of specialId" do
      stub_get("/campaigns/list?oauth_token=#{@client.oauth_token}&specialId=4e0debea922e6f94b1410bb7", "campaigns/campaigns_list.json")
